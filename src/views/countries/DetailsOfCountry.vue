<template>
	<div class="container py-5 px-lg-0 fs-5">
		<router-link to="/">
			<button class="btn btn-white px-5 ps-4 fs-6 ms-4 ms-lg-0">
				<i class="fa-solid fa-arrow-left-long fa-lg mx-2"></i>Back
			</button>
		</router-link>
		<div v-if="country.length" class="row justify-content-center mt-5 gx-5">
			...
			<div class="col-12 col-lg-7">
				<h1 class="fw-bold fs-1 mb-3 mt-2 mb-lg-3 mt-lg-5">
				...
				>
					...
					<router-link
						:to="{ name: 'Country', params: { id: nameCountry.name.common } }"
						v-for="nameCountry in borders"
...
export default {
	...
	setup(props) {
		let { country, borders, errors, getCountryById, getCountryByName } =
			getCountry();
